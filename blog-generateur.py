#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fabrique les pages du blog Loc'Air (/blog).

Le contenu est dans blog_contenu.py ; les morceaux communs à toutes les
pages de texte (barre, pied, balises de partage) dans locair_gabarit.py.

RÈGLE : aucun chiffre, aucun modèle, aucune date, aucun prix, aucun avis qui
ne soit pas déjà écrit sur le site.
"""
import os, re, html
