...
create table reservation_fenetres (
  id             bigint generated always as identity primary key,
  reservation_id bigint not null references reservations(id) on delete cascade,
  type           text not null,
...
create index reservation_fenetres_resa_idx on reservation_fenetres (reservation_id);
...
create table documents (
  id                bigint generated always as identity primary key,
  reservation_id    bigint not null references reservations(id) on delete cascade,
  type              text not null check (type in ('contrat','facture','facture_vente','avenant')),
  numero            text,
  version           text not null,
