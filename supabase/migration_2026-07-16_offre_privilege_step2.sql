-- ================================================================
-- OFFRE PRIVILÈGE — Step 2 : prix, achat côté client, retrait du parc.
-- Ajoute la valeur "vendu" à appareils.statut (un climatiseur acheté par
-- son locataire actuel sort définitivement de la location) et l'exclut des
-- deux fonctions qui calculent la disponibilité, comme panne/maintenance.
-- ================================================================
...
alter table appareils add constraint appareils_statut_check
  check (statut in ('disponible','panne','maintenance','loue','nettoyage','vendu'));
